...
def initialize_network(n_inputs, n_hidden, n_outputs):
    ...
    output_layer = [{'weights': [random() for i in range(n_outputs)]}]
...
inputColumns = ["cyl", "disp", "hp", "drat", "wt", "qsec", "vs", "am", "gear", "carb"]
#
n_inputs = np.array(dataset[inputColumns])
n_outputs = dataset["mpg"]
